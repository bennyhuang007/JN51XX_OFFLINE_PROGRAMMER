...
//MARK(A)
//!!!Caution!!!
//if modify the GPIO Pin blow,please modify the MARK(A) MARK(B) in bsp.c

// CHIP1
#define GPIO_CHIP1_RST_PORT             GPIOC
#define GPIO_CHIP1_RST_SHIFT            13
#define GPIO_CHIP1_RST_PIN              (1ul<<GPIO_CHIP1_RST_SHIFT)
#define GPIO_CHIP1_SIG_PORT             GPIOC           // Must Remap
#define GPIO_CHIP1_SIG_SHIFT            14
#define GPIO_CHIP1_SIG_PIN              (1ul<<GPIO_CHIP1_SIG_SHIFT)
#define GPIO_CHIP1_PWR_PORT             GPIOA
#define GPIO_CHIP1_PWR_SHIFT            4
#define GPIO_CHIP1_PWR_PIN              (1ul<<GPIO_CHIP1_PWR_SHIFT)
#define GPIO_CHIP1_ADC_PORT             GPIOC
#define GPIO_CHIP1_ADC_SHIFT            0
#define GPIO_CHIP1_ADC_PIN              (1ul<<GPIO_CHIP1_ADC_SHIFT)

// CHIP2
#define GPIO_CHIP2_RST_PORT             GPIOB
#define GPIO_CHIP2_RST_SHIFT            1
#define GPIO_CHIP2_RST_PIN              (1ul<<GPIO_CHIP2_RST_SHIFT)
#define GPIO_CHIP2_SIG_PORT             GPIOA
#define GPIO_CHIP2_SIG_SHIFT            0
#define GPIO_CHIP2_SIG_PIN              (1ul<<GPIO_CHIP2_SIG_SHIFT)
#define GPIO_CHIP2_PWR_PORT             GPIOA
#define GPIO_CHIP2_PWR_SHIFT            6
#define GPIO_CHIP2_PWR_PIN              (1ul<<GPIO_CHIP2_PWR_SHIFT)
#define GPIO_CHIP2_ADC_PORT             GPIOC
#define GPIO_CHIP2_ADC_SHIFT            2
#define GPIO_CHIP2_ADC_PIN              (1ul<<GPIO_CHIP2_ADC_SHIFT)

// CHIP3
#define GPIO_CHIP3_RST_PORT             GPIOB
#define GPIO_CHIP3_RST_SHIFT            0
#define GPIO_CHIP3_RST_PIN              (1ul<<GPIO_CHIP3_RST_SHIFT)
#define GPIO_CHIP3_SIG_PORT             GPIOA
#define GPIO_CHIP3_SIG_SHIFT            1
#define GPIO_CHIP3_SIG_PIN              (1ul<<GPIO_CHIP3_SIG_SHIFT)
#define GPIO_CHIP3_PWR_PORT             GPIOA
#define GPIO_CHIP3_PWR_SHIFT            7
#define GPIO_CHIP3_PWR_PIN              (1ul<<GPIO_CHIP3_PWR_SHIFT)
#define GPIO_CHIP3_ADC_PORT             GPIOC
#define GPIO_CHIP3_ADC_SHIFT            3
#define GPIO_CHIP3_ADC_PIN              (1ul<<GPIO_CHIP3_ADC_SHIFT)

// CHIP4
#define GPIO_CHIP4_RST_PORT             GPIOB
#define GPIO_CHIP4_RST_SHIFT            7
#define GPIO_CHIP4_RST_PIN              (1ul<<GPIO_CHIP4_RST_SHIFT)
#define GPIO_CHIP4_SIG_PORT             GPIOC           // Must Remap
#define GPIO_CHIP4_SIG_SHIFT            15
#define GPIO_CHIP4_SIG_PIN              (1ul<<GPIO_CHIP4_SIG_SHIFT)
#define GPIO_CHIP4_PWR_PORT             GPIOA
#define GPIO_CHIP4_PWR_SHIFT            5
#define GPIO_CHIP4_PWR_PIN              (1ul<<GPIO_CHIP4_PWR_SHIFT)
#define GPIO_CHIP4_ADC_PORT             GPIOC
#define GPIO_CHIP4_ADC_SHIFT            1
#define GPIO_CHIP4_ADC_PIN              (1ul<<GPIO_CHIP4_ADC_SHIFT)

#define GPIO_CHIP1_RST_LOW()            (GPIO_ResetBits(GPIO_CHIP1_RST_PORT,GPIO_CHIP1_RST_PIN))
#define GPIO_CHIP1_RST_HIGH()           (GPIO_SetBits(GPIO_CHIP1_RST_PORT,GPIO_CHIP1_RST_PIN))
#define GPIO_CHIP1_SIG_LOW()            (GPIO_ResetBits(GPIO_CHIP1_SIG_PORT,GPIO_CHIP1_SIG_PIN))
#define GPIO_CHIP1_SIG_HIGH()           (GPIO_SetBits(GPIO_CHIP1_SIG_PORT,GPIO_CHIP1_SIG_PIN))
#define GPIO_CHIP1_PWR_LOW()            (GPIO_ResetBits(GPIO_CHIP1_PWR_PORT,GPIO_CHIP1_PWR_PIN))
#define GPIO_CHIP1_PWR_HIGH()           (GPIO_SetBits(GPIO_CHIP1_PWR_PORT,GPIO_CHIP1_PWR_PIN))

#define GPIO_CHIP2_RST_LOW()            (GPIO_ResetBits(GPIO_CHIP2_RST_PORT,GPIO_CHIP2_RST_PIN))
#define GPIO_CHIP2_RST_HIGH()           (GPIO_SetBits(GPIO_CHIP2_RST_PORT,GPIO_CHIP2_RST_PIN))
#define GPIO_CHIP2_SIG_LOW()            (GPIO_ResetBits(GPIO_CHIP2_SIG_PORT,GPIO_CHIP2_SIG_PIN))
#define GPIO_CHIP2_SIG_HIGH()           (GPIO_SetBits(GPIO_CHIP2_SIG_PORT,GPIO_CHIP2_SIG_PIN))
#define GPIO_CHIP2_PWR_LOW()            (GPIO_ResetBits(GPIO_CHIP2_PWR_PORT,GPIO_CHIP2_PWR_PIN))
#define GPIO_CHIP2_PWR_HIGH()           (GPIO_SetBits(GPIO_CHIP2_PWR_PORT,GPIO_CHIP2_PWR_PIN))

#define GPIO_CHIP3_RST_LOW()            (GPIO_ResetBits(GPIO_CHIP3_RST_PORT,GPIO_CHIP3_RST_PIN))
#define GPIO_CHIP3_RST_HIGH()           (GPIO_SetBits(GPIO_CHIP3_RST_PORT,GPIO_CHIP3_RST_PIN))
#define GPIO_CHIP3_SIG_LOW()            (GPIO_ResetBits(GPIO_CHIP3_SIG_PORT,GPIO_CHIP3_SIG_PIN))
#define GPIO_CHIP3_SIG_HIGH()           (GPIO_SetBits(GPIO_CHIP3_SIG_PORT,GPIO_CHIP3_SIG_PIN))
#define GPIO_CHIP3_PWR_LOW()            (GPIO_ResetBits(GPIO_CHIP3_PWR_PORT,GPIO_CHIP3_PWR_PIN))
#define GPIO_CHIP3_PWR_HIGH()           (GPIO_SetBits(GPIO_CHIP3_PWR_PORT,GPIO_CHIP3_PWR_PIN))

#define GPIO_CHIP4_RST_LOW()            (GPIO_ResetBits(GPIO_CHIP4_RST_PORT,GPIO_CHIP4_RST_PIN))
#define GPIO_CHIP4_RST_HIGH()           (GPIO_SetBits(GPIO_CHIP4_RST_PORT,GPIO_CHIP4_RST_PIN))
#define GPIO_CHIP4_SIG_LOW()            (GPIO_ResetBits(GPIO_CHIP4_SIG_PORT,GPIO_CHIP4_SIG_PIN))
#define GPIO_CHIP4_SIG_HIGH()           (GPIO_SetBits(GPIO_CHIP4_SIG_PORT,GPIO_CHIP4_SIG_PIN))
#define GPIO_CHIP4_PWR_LOW()            (GPIO_ResetBits(GPIO_CHIP4_PWR_PORT,GPIO_CHIP4_PWR_PIN))
#define GPIO_CHIP4_PWR_HIGH()           (GPIO_SetBits(GPIO_CHIP4_PWR_PORT,GPIO_CHIP4_PWR_PIN))

// LED
#define GPIO_LED_COM_PORT               GPIOC
#define GPIO_LED_USB_SHIFT              9
#define GPIO_LED_CHIP1_SHIFT            8
#define GPIO_LED_CHIP2_SHIFT            7
#define GPIO_LED_CHIP3_SHIFT            6
#define GPIO_LED_CHIP4_SHIFT            5

#define GPIO_LED_USB_PIN                (1ul<<GPIO_LED_USB_SHIFT)
#define GPIO_LED_CHIP1_PIN              (1ul<<GPIO_LED_CHIP1_SHIFT)
#define GPIO_LED_CHIP2_PIN              (1ul<<GPIO_LED_CHIP2_SHIFT)
#define GPIO_LED_CHIP3_PIN              (1ul<<GPIO_LED_CHIP3_SHIFT)
#define GPIO_LED_CHIP4_PIN              (1ul<<GPIO_LED_CHIP4_SHIFT)
#define GPIO_LED_COM_PIN_MASK           (GPIO_LED_CHIP1_PIN|GPIO_LED_CHIP2_PIN|GPIO_LED_CHIP3_PIN|GPIO_LED_CHIP4_PIN|GPIO_LED_USB_PIN)
#define GPIO_LED_COM_LOW(PIN)           (GPIO_ResetBits(GPIO_LED_COM_PORT,PIN))
#define GPIO_LED_COM_HIGH(PIN)          (GPIO_SetBits(GPIO_LED_COM_PORT,PIN))

#define GPIO_LED_R_PORT                 GPIOB
#define GPIO_LED_R_SHIFT                15
#define GPIO_LED_R_PIN                  (1ul<<GPIO_LED_R_SHIFT)
#define GPIO_LED_G_PORT                 GPIOB
#define GPIO_LED_G_SHIFT                14
#define GPIO_LED_G_PIN                  (1ul<<GPIO_LED_G_SHIFT)
#define GPIO_LED_R_LOW()                (GPIO_ResetBits(GPIO_LED_R_PORT,GPIO_LED_R_PIN))
#define GPIO_LED_R_HIGH()               (GPIO_SetBits(GPIO_LED_R_PORT,GPIO_LED_R_PIN))
#define GPIO_LED_G_LOW()                (GPIO_ResetBits(GPIO_LED_G_PORT,GPIO_LED_G_PIN))
#define GPIO_LED_G_HIGH()               (GPIO_SetBits(GPIO_LED_G_PORT,GPIO_LED_G_PIN))
// CLK OUT
#define GPIO_CLKOUT_PORT                GPIOA
#define GPIO_CLKOUT_SHIFT               8
#define GPIO_CLKOUT_PIN                 (1ul<<GPIO_CLKOUT_SHIFT)

// ADCs
#define GPIO_ADC_VCC_PORT               GPIOC
#define GPIO_ADC_VCC_SHIFT              4
#define GPIO_ADC_VCC_PIN                (1ul<<GPIO_ADC_VCC_SHIFT)

// USB
#define GPIO_USB_PWRCHK_PORT            GPIOB
#define GPIO_USB_PWRCHK_SHIFT           12
#define GPIO_USB_PWRCHK_PIN             (1ul<<GPIO_USB_PWRCHK_SHIFT)
#define GPIO_USB_PWRCHK_VAL()           (GPIO_ReadInputDataBit(GPIO_USB_PWRCHK_PORT,GPIO_USB_PWRCHK_PIN))

#define GPIO_USB_EN_PORT                GPIOB
#define GPIO_USB_EN_SHIFT               13
#define GPIO_USB_EN_PIN                 (1ul<<GPIO_USB_EN_SHIFT)
#define GPIO_USB_EN_LOW()               (GPIO_ResetBits(GPIO_USB_EN_PORT,GPIO_USB_EN_PIN))
#define GPIO_USB_EN_HIGH()              (GPIO_SetBits(GPIO_USB_EN_PORT,GPIO_USB_EN_PIN))

// KEY START
#define GPIO_KEY_START_PORT             GPIOB
#define GPIO_KEY_START_SHIFT            6
#define GPIO_KEY_START_PIN              (1ul<<GPIO_KEY_START_SHIFT)
#define GPIO_KEY_START_VAL()            (GPIO_ReadInputDataBit(GPIO_KEY_START_PORT,GPIO_KEY_START_PIN))

// SPI_NSS
#define GPIO_SPI_NSS_PORT               GPIOA                   // Must Remap
#define GPIO_SPI_NSS_SHIFT              15
#define GPIO_SPI_NSS_PIN                (1ul<<GPIO_SPI_NSS_SHIFT)
#define GPIO_SPI_NSS_LOW()              (GPIO_ResetBits(GPIO_SPI_NSS_PORT,GPIO_SPI_NSS_PIN))
#define GPIO_SPI_NSS_HIGH()             (GPIO_SetBits(GPIO_SPI_NSS_PORT,GPIO_SPI_NSS_PIN))

//!!!Caution!!!

extern void BSP_GPIO_ChangeRSTSIGMode(IO_MODE eIOMode);
extern void BSP_GPIO_CLKOUT_Config(bool bEnable);
